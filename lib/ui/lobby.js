...
export default class Lobby {
  constructor(socket) {
    ...
    this.el = el('.lobby',
      el('',
        ...
        el('',
          ...
          this.nickInput = el('input', { type: 'text', id: 'nick', maxlength: 22 })
        ),
        this.accountButton = el('button', {type: 'button'}, 'Your account / key bindings')
      ),
      el('table',
        el('thead',
          el('tr',
    ...
    this.accountButton.onclick = (ev) => {
      ev.preventDefault();
      dispatch(this, 'ViewAccount');
    }
  }
