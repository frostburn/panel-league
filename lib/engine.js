...
const defaultOptions = {
  width: 6,
  height: 8,
  stepper: panelLeague.StandardStepper,
};

const steppers = [panelLeague.StandardStepper, panelLeague.ScoringStepper, panelLeague.VsStepper];

class GameEngine {
  constructor(options = {}) {
    const stepperClass = defaultTo(options.stepper, defaultOptions.stepper);
